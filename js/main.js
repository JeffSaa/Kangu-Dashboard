...
KanguDashboard.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
	...
	$stateProvider
		...
		// Supervisor
		.state('supervisor_dashboard', {
			url: "/supervisor",
			templateUrl: "../views/supervisor_dashboard.html",            
		...
		.state('credit_note', {
			url: "/credit_note",
			templateUrl: "../views/credit_note.html",            
			data: {pageTitle: 'Supervisor Dashboard'},
				...
				deps: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load({
						...
						files: [
							...
							'../js/controllers/CreditNoteController.js',
						] 
					});
				}]
			}
		...
		// Shopping and Sales
		.state('shopping_sales', {
			url: "/shopping_sales",
			templateUrl: "../views/shopping_sales.html",            
			data: {pageTitle: 'Supervisor Dashboard'},
			controller: "ShoppingSalesController",
			resolve: {
				deps: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load({
						name: 'KanguDashboard',
						...
						files: [
							...
							'../js/controllers/ShoppingSalesController.js',
						] 
					});
				}]
			}
